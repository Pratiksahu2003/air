...
<head>
    ...
    <title>Flight Search Request Received - {{ config('site.name') }}</title>
    <!--[if mso]>
    <style type="text/css">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:650px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding:24px 32px 8px 32px;">
                            <h1 style="margin:0 0 12px 0; font-size:26px; font-weight:700; color:#1a1a1a; line-height:1.3;">Thank You for Your Flight Search Request!</h1>
                            <p style="margin:0; font-size:15px; color:#4b5563; line-height:1.6;">Hello,</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:8px 32px 24px 32px;">
                            <p style="margin:0 0 16px 0; font-size:15px; color:#4b5563; line-height:1.7;">
                                We've received your flight search request and our travel experts are already working on finding the best flight options for you.
                            </p>
                            <p style="margin:0; font-size:15px; color:#4b5563; line-height:1.7;">
                                Our team will contact you at <strong style="color:#1a1a1a;">{{ $data['email'] }}</strong> or <strong style="color:#1a1a1a;">{{ $data['contact_number'] }}</strong> within <strong style="color:#0d6efd;">24 hours</strong> with personalized flight recommendations and the best available deals.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 32px 24px 32px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius:12px; padding:24px; border:1px solid #dee2e6;">
                                ...
                                <tr>
                                    <td>
                                        <div style="font-size:13px; color:#6c757d; text-transform:uppercase; font-weight:600; letter-spacing:0.5px; margin-bottom:16px; text-align:center;">Your Flight Search Details</div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding-top:20px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;">
                                            <tr>
                                                <td style="padding:10px 0; width:140px; color:#495057; font-weight:600;">Trip Type</td>
                                                <td style="padding:10px 0; color:#1a1a1a;">
                                                    <span style="display:inline-block; background:#0d6efd; color:#ffffff; padding:6px 16px; border-radius:20px; font-size:13px; font-weight:600; text-transform:capitalize;">{{ ucfirst($data['trip_type']) }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:10px 0; color:#495057; font-weight:600;">Departure Date</td>
                                            ...
                                            @endif
                                            <tr>
                                                <td style="padding:10px 0; color:#495057; font-weight:600;">Passengers</td>
                                                <td style="padding:10px 0; color:#1a1a1a;">
                                                    <span style="display:inline-block; margin-right:16px; background:#ffffff; padding:6px 12px; border-radius:6px; border:1px solid #dee2e6;"><strong>{{ $data['adults'] }}</strong> Adult{{ $data['adults'] > 1 ? 's' : '' }}</span>
                                                    @if($data['children'] > 0)
                                                    <span style="display:inline-block; margin-right:16px; background:#ffffff; padding:6px 12px; border-radius:6px; border:1px solid #dee2e6;"><strong>{{ $data['children'] }}</strong> Child{{ $data['children'] > 1 ? 'ren' : '' }}</span>
                                                    @endif
                                                    @if($data['infants'] > 0)
                                                    <span style="display:inline-block; background:#ffffff; padding:6px 12px; border-radius:6px; border:1px solid #dee2e6;"><strong>{{ $data['infants'] }}</strong> Infant{{ $data['infants'] > 1 ? 's' : '' }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <ul style="margin:0; padding-left:20px; font-size:14px; color:#856404; line-height:1.8;">
                                            ...
                                            <li>We'll search for the best flight options matching your criteria</li>
