...
<head>
    ...
    <title>New Flight Search Request - {{ config('site.name') }}</title>
    <!--[if mso]>
    <style type="text/css">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:650px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding:24px 32px 8px 32px;">
                            <h1 style="margin:0 0 8px 0; font-size:24px; font-weight:700; color:#1a1a1a; line-height:1.3;">New Flight Search Request</h1>
                            <p style="margin:0; font-size:14px; color:#6b7280; line-height:1.5;">A customer has submitted a flight search request from your website.</p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding-top:16px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;">
                                            <tr>
                                                <td style="padding:8px 0; width:140px; color:#495057; font-weight:600;">Trip Type</td>
                                                <td style="padding:8px 0; color:#1a1a1a;">
                                                    <span style="display:inline-block; background:#0d6efd; color:#ffffff; padding:4px 12px; border-radius:20px; font-size:12px; font-weight:600; text-transform:capitalize;">{{ ucfirst($data['trip_type']) }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:8px 0; color:#495057; font-weight:600;">Departure Date</td>
                                            ...
                                            @endif
                                            <tr>
                                                <td style="padding:8px 0; color:#495057; font-weight:600;">Passengers</td>
                                                <td style="padding:8px 0; color:#1a1a1a;">
                                                    <span style="display:inline-block; margin-right:12px;"><strong>{{ $data['adults'] }}</strong> Adult{{ $data['adults'] > 1 ? 's' : '' }}</span>
                                                    @if($data['children'] > 0)
                                                    <span style="display:inline-block; margin-right:12px;"><strong>{{ $data['children'] }}</strong> Child{{ $data['children'] > 1 ? 'ren' : '' }}</span>
                                                    @endif
                                                    @if($data['infants'] > 0)
                                                    <span style="display:inline-block;"><strong>{{ $data['infants'] }}</strong> Infant{{ $data['infants'] > 1 ? 's' : '' }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; padding:20px; border:1px solid #e9ecef;">
                                <tr>
                                    <td>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;">
                                            <tr>
                                                <td style="padding:6px 0; color:#495057; font-weight:600; width:120px;">Email</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:6px 0;">
                                                    <a href="tel:{{ $data['contact_number'] }}" style="color:#0d6efd; text-decoration:none; font-weight:500;">{{ $data['contact_number'] }}</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td style="padding:0 32px 32px 32px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="mailto:{{ $data['email'] }}?subject=Re: Flight Search Request - {{ $data['from_city'] }} to {{ $data['to_city'] }}" style="display:inline-block; background:linear-gradient(135deg, #0d6efd 0%, #0056b3 100%); color:#ffffff; text-decoration:none; padding:14px 32px; border-radius:8px; font-weight:600; font-size:15px; box-shadow:0 4px 12px rgba(13, 110, 253, 0.3);">Contact Customer</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td colspan="2" style="padding-top:16px; border-top:1px solid #e9ecef; text-align:center;">
                                        <p style="margin:0; font-size:11px; color:#9ca3af;">
                                            This email was automatically generated from the flight search form on {{ config('site.name') }}.
                                        </p>
                                    </td>
                                </tr>
                            </table>
